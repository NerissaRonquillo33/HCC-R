...
import com.example.hcc.interfaces.TokenDao;
...
@androidx.room.Database(entities = {Students.class, Schedules.class, Grades.class, Bills.class, Announcements.class, Settings.class, Token.class}, version = 1)
