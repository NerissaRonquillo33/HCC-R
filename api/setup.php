...
$sql = "SELECT 'add table _parents with id, fullname, student_id, username, password, email';DROP TABLE IF EXISTS _parents;CREATE TABLE _parents ( id INT AUTO_INCREMENT PRIMARY KEY, fullname VARCHAR(255) NOT NULL, student_id INT NOT NULL, username VARCHAR(255) NOT NULL UNIQUE, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL );SHOW TABLES;";
