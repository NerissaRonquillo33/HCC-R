...
$sql = "SELECT 'add table _parents with id, firstname, lastname, student_id, username, password, email';DROP TABLE IF EXISTS _tokens;CREATE TABLE _tokens ( id INT AUTO_INCREMENT PRIMARY KEY, username TEXT NOT NULL, token LONGTEXT NOT NULL UNIQUE, last_record_bill_id INT );SHOW TABLES;";
