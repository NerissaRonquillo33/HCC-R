...
$sql = "SELECT 'add table _parents with id, firstname, lastname, student_id, username, password, email';DROP TABLE IF EXISTS _tokens;CREATE TABLE _tokens ( id INT AUTO_INCREMENT PRIMARY KEY, token LONGTEXT NOT NULL );SHOW TABLES;";
